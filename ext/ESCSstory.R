...
student2012o <- na.omit(student2012[student2012$OECD == "OECD",c("ESCS","W_FSTUWT")])
do2012 <- density(student2012o$ESCS, weights=student2012o$W_FSTUWT, bw=.01, from=-3, to=3)
